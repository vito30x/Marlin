 ...
 */
#define USE_CONTROLLER_FAN  //+++vito+++ Mainboard Luefter - war deaktiviert
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN FAN2_PIN     // Set a custom pin for the controller fan //+++vito+++ Mainboard FAN2-Anschluss - war -1 - war deaktiviert
  #define CONTROLLER_FAN2_PIN FAN3_PIN  // Set a custom pin for second controller fan //+++vito+++ Noktua Gehäuse Ausgangslüfter
  //#define CONTROLLER_FAN_USE_Z_ONLY       // With this option only the Z axis is considered
  #define CONTROLLER_FAN_IGNORE_Z         // Ignore Z stepper. Useful when stepper timeout is disabled. //+++vito+++ - war deaktiviert
  #define CONTROLLERFAN_SPEED_MIN         0 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
  #define CONTROLLERFAN_SPEED_ACTIVE    125 // (0-255) Active speed, used when any motor is enabled //+++vito+++ Reduziert auf 50% Vyper-BTT-V-2.2b
  ...
  #define CONTROLLER_FAN_EDITABLE         // Enable M710 configurable settings //+++vito+++ war deaktiviert - zum steuern des Mainboardfans
 ...
 */
//#define FAN_MIN_PWM 25 //+++vito+++ wert war 50 -war aktiviert in Vyper-BTT-V-1.4b deaktiviert 
...
//#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  #define FAST_PWM_FAN_FREQUENCY 31400  // Define here to override the defaults below //aktiviert für Pulsieren Infinity-BTT-V-2.5b
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // +++vito+++ FAN1 Hotend zugeordnet
 ...
 */
#define CASE_LIGHT_ENABLE                         // aktiviert Vyper-BTT-V-2.5
#if ENABLED(CASE_LIGHT_ENABLE)
  #define CASE_LIGHT_PIN FAN5_PIN                  // Override the default pin if needed default war 4 // geändert aktiviert Vyper-BTT-V-2.5
  #define INVERT_CASE_LIGHT false             // Set true if Case Light is ON when pin is LOW
  #define CASE_LIGHT_DEFAULT_ON true          // Set default power-up state on
  #define CASE_LIGHT_DEFAULT_BRIGHTNESS 255   // Set default power-up brightness (0-255, requires PWM pin)  // geändert Vyper-BTT-V-2.5
  //#define CASE_LIGHT_NO_BRIGHTNESS          // Disable brightness control. Enable for non-PWM lighting.
  //#define CASE_LIGHT_MAX_PWM 128            // Limit PWM duty cycle (0-255)
  #define CASE_LIGHT_MENU                   // Add Case Light options to the LCD menu // aktiviert  Vyper-BTT-V-2.5
...
#define HOMING_BUMP_DIVISOR { 5, 5, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate) default { 2, 2, 4 } // Infinity-BTT-V-2.6b
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 300 // vito - default war 500 - Vyper-BTT-V-2.1b
   ...
   */
  #define BLTOUCH_SET_5V_MODE // fuer BLTouch aktiviert - war deaktiviert
   ...
   */
  #define BLTOUCH_HS_MODE true // vito - für schnelleres Leveln - Vyper-BTT-V-2.1b
 ...
 */
#define Z_STEPPER_AUTO_ALIGN //+++vito+++ DUAL Z - war deaktiviert
   ...
   */
  #define Z_STEPPER_ALIGN_XY { {  10, 125 }, { 240,  125 } }
   ...
   */
    ...
    #define Z_STEPPERS_ORIENTATION 0 // +++vito+++ Dual Z für Auto Align - war deaktiviert // Infinity-BTT-V-2.6b
  #endif
   ...
   * driver order.
   */
  //#define Z_STEPPER_ALIGN_STEPPER_XY { { 45, 125 }, { 205, 125 } } // war { { 210.7, 102.5 }, { 152.6, 220.0 }, { 94.5, 102.5 } }
  ...
  // On a 300mm bed a 5% grade would give a misalignment of ~1.5cm //+++vito+++ DUAL Z - hier einstellungen im Absatz
  #define G34_MAX_GRADE              10    // (%) Maximum incline that G34 will handle //von 5 auf 10 Infinity-BTT-V-2.6b
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu // fuer BLTouch Aktiviert - war deaktiviert
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -4.0 // fuer BLTouch - war deaktiviert

    // Set a convenient position to do the calibration (probing point and nozzle/bed-distance)
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER } //+++vito+++ fuer Wuzzard aktiviert - war deaktiviert
  #endif
#endif
    ...
    //#define X_AXIS_TWIST_COMPENSATION // aktiviert in Infinity-BTT-V-3.0b
  ...
  #define LCD_INFO_MENU //+++vito+++ fuer Wuzzard aktiviert - war deaktiviert
...
#define SET_PROGRESS_MANUALLY  // aktiviert in V4.0 für Plugin Detail Progress
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' //+++vito+++ war deaktiviert
  ...
  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>' //+++vito+++ war deaktiviert
 ...
 */
#define BABYSTEPPING // fuer BLTouch - war deaktiviert
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  #define BABYSTEP_WITHOUT_HOMING  // fuer BLTouch - war deaktiviert
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement). // fuer BLTouch - war deaktiviert
  #define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA! // war deaktiviert - Vyper-BTT-V-2.2b
  #define BABYSTEP_INVERT_Z false           // Change if Z babysteps should go the other way
  //#define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps
  #define BABYSTEP_MULTIPLICATOR_Z  1       // (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 1       // (steps or mm) Steps or millimeter distance for each XY babystep

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. // fuer BLTouch - war deaktiviert
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping // fuer BLTouch aktiviert - war deaktiviert
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // Enable graphical overlay on Z-offset editor // fuer BLTouch - war deaktiviert
  #endif
#endif
 ...
 */
#define G29_RETRY_AND_RECOVER // fuer BLTouch - war deaktiviert
 ...
 */
#define EMERGENCY_PARSER  //+++vito+++ war deaktiviert tft
...
#define SERIAL_FLOAT_PRECISION 4  //+++vito+++ war deaktiviert tft
 ...
 */
#define FWRETRACT //+++vito+++ war deaktiviert
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change. //+++vito+++ war deaktiviert tft
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu. //+++vito+++ aktiviert -war deaktiviert
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_MICROSTEPS     32        // 0..256 Vyper-BTT-V-2.1b // zurück von 32 auf 16 Infinity-BTT-V-2.6b
    ...
    #define Y_MICROSTEPS     32         // zurück von 32 auf 16 Infinity-BTT-V-2.6b
   ...
   */
  #define CHOPPER_TIMING CHOPPER_09STEP_24V         // All axes (override below) //+++vito+++ war CHOPPER_DEFAULT_12V
  ...
  #define CHOPPER_TIMING_E  CHOPPER_DEFAULT_24V        // For Extruders (override below) //geändert Infinity-BTT-V-2.5b
   ...
   */
  #define MONITOR_DRIVER_STATUS // +++vito+++ - war deaktiviert Stealtshop
   ...
   */
  #define HYBRID_THRESHOLD // aktiviert für stealthshop Vyper-BTT-V-3.0b
   ...
   */
  #define SQUARE_WAVE_STEPPING // default deaktiviert / aktiviert in Infinity-BTT-V-3.0b

  /**
   * Enable M122 debugging command for TMC stepper drivers.
   * M122 S0/1 will enable continuous reporting.
   */
  #define TMC_DEBUG // +++vito+++ - DRIVERS - war deaktiviert Stealtshop
 ...
 */
#define AUTO_REPORT_POSITION //+++vito+++/ war deaktiviert
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT //+++vito+++/ war deaktiviert
#endif
...
#define M114_DETAIL  //+++vito - war deaktiviert  // Use 'M114` for details to check planner calculations 
...
#define GCODE_CASE_INSENSITIVE  // Accept G-code sent to the firmware in lowercase // aktiviert Infinity-BTT-V-2.5b
 ...
 */
#define HOST_ACTION_COMMANDS  //+++vito+++ war deaktiviert tft
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback  //+++vito+++ war deaktiviert tft
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications  //+++vito+++ war deaktiviert tft
  #endif
